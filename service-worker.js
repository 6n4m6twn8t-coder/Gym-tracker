const CACHE='project-athlete-core-v9';
const ASSETS=['./','./index.html','./styles.css?v=11','./home.css?v=13','./app.js?v=8','./program-60.js?v=12','./home-icons.js?v=13','./manifest.webmanifest'];
