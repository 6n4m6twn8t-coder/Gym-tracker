const CACHE='project-athlete-core-v14';
const ASSETS=['./','./index.html','./styles.css?v=11','./home.css?v=16','./home-anatomy.css?v=18','./app.js?v=8','./program-60.js?v=12','./home-icons.js?v=18','./manifest.webmanifest'];
